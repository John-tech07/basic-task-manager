...
function App() {
    ...
    const { tasks, loading: tasksLoading, addTask, toggleTask, editTask, deleteTask } = useTasks();
            ...
            <div className="w-full max-w-4xl mx-auto">
                <header className="relative flex items-center justify-center py-6 sm:py-8 lg:py-10">
                    ...
                    <div className="absolute right-0 top-1/2 -translate-y-1/2" ref={menuRef}>
                        ...
                        {menuOpen && (
                            <div className="absolute right-0 top-full mt-1 w-56 bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden z-10">
                ...
                {tasksLoading ? (
                    <div className="flex items-center justify-center py-20">
                        <span className="text-slate-400 text-sm">Carregando tarefas...</span>
                    </div>
                ) : (
